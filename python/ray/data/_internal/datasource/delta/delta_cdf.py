...
def read_delta_cdf_distributed(
    ...
    actual_ending_version = ending_version if ending_version is not None else dt.version()
    ...
    for i in range(0, version_range, versions_per_task):
        ...
        chunk_end = min(starting_version + i + versions_per_task - 1, actual_ending_version)
